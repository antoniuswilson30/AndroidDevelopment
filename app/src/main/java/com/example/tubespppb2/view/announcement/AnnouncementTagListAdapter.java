...
public class AnnouncementTagListAdapter extends BaseAdapter {
    ...
    public AnnouncementTagListAdapter(Activity activity, HashMap<String,String> mp){
    ...
    public List<TagGetResponse> getTagSelected(){
        List <TagGetResponse> temp = new ArrayList<>();
