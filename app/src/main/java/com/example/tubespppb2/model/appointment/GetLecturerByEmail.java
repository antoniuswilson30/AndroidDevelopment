...
public class GetLecturerByEmail {
    ...
    public GetLecturerByEmail(Context context, IError iError, IAppointmentJadwalDosen iAppointmentJadwalDosen) {
            ...
            responseCall.enqueue(new Callback<UsersGetByEmailResponse>() {
                ...
                public void onResponse(Call<UsersGetByEmailResponse> call, Response<UsersGetByEmailResponse> response) {
                    if (response.isSuccessful()) {
                        iAppointmentJadwalDosen.getLecturerId(response.body());
